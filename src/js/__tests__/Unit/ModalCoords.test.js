...
describe('ModalCoords', () => {
  ...
  describe('Отобразит сообщение об ошибке, если пользователь вводит неверные данные', () => {
    test.each([
      '',
      '511.50851, −0.12572',
      '-5.50851, 120.12572',
  ...
  describe('Не отображает сообщение об ошибке, если пользователь вводит корректные данные', () => {
    test.each([
      '51.50851,-0.12572',
      '51.50851, 0.12572',
      '-51.5085123, 0.12572',
  ...
  describe('Возвращает объект с координатами, если пользователь вводит данные', () => {
    test.each`
    latitude     | longitude
    ${51.50851}  | ${0.12572}
    ${-15.50851} | ${-10.12572}
